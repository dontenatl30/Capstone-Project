...
}); // ORIGINAL WORKING CODE THAT ALLOWED IMAGES TO BE STORED IN UPLAODS FOLDER FROM API FRONTEND CALL
...
app.get('/get-images-by-theme', async (req, res) => {
  try {
    ...
    // Query your database to get images based on the theme
    const images = await Puzzle.findAll({
      where: { theme: theme }, // Assuming "theme" is the field name in your model
    });
